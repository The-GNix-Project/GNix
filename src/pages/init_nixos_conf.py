from PyQt5.QtWidgets import QWidget, QTreeView, QPushButton, QFileDialog, QLineEdit, QCheckBox
...
class InitNixosConfig(QWidget):
    def __init__(self):
        ...
        folderIcon = QIcon('src/qt/assets/icons/folder.png')
        nixIcon = QIcon('src/qt/assets/icons/nix.png')
